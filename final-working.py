...
json_file_paths = ["a.json","b.json","c.json","d.json","e.json","f.json","g.json","h.json","i.json","j.json","k.json"]   
...
def process_json_files(file_paths):
    try:
        ...
        # Ensure each document content is a string
        ...
        # Log split_docs content for debugging
        ...
        try:
            # Check if the first document content is a valid string
...
def rephrase_query_tool(query):
    ...
    try:
        ...
        # Update response handling based on the actual response format
        if isinstance(response, dict) and 'generated_text' in response:
            return response['generated_text']
        else:
            logging.warning("Response object does not have 'generated_text' attribute or is not in expected format.")
            return None
    except Exception as e:
